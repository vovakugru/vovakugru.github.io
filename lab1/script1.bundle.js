...
const resultLab1 = document.getElementById('result');

const type = document.getElementById('type');

const w = document.getElementById('_w');
const uw = document.getElementById('_uw');
const dw = document.getElementById('_dw');
const uws = document.getElementById('_uws');
const uwg = document.getElementById('_uwg');
const p = document.getElementById('_p');

function disableAll() {
    w.classList.replace('visible', 'hidden');
    uw.classList.replace('visible', 'hidden');
    dw.classList.replace('visible', 'hidden');
    uws.classList.replace('visible', 'hidden');
    uwg.classList.replace('visible', 'hidden');
    p.classList.replace('visible', 'hidden');
    resultLab1.classList.replace('hidden', 'visible');
}

function pickaxeChange(minLvl, name) {
    const curr = document.getElementById('p');
    curr.addEventListener('change', function () {
        disableAll();
        if (curr.value < minLvl) {
            resultLab1.innerText = 'Я получу: ничего';
        } else {
            resultLab1.innerText = `Я получу: 2-5 необработанных куска руды (${name})`;
        }
    });
}

function pickaxe(minLvl, name) {
    w.classList.replace('visible', 'hidden');
    uw.classList.replace('visible', 'hidden');
    dw.classList.replace('visible', 'hidden');
    uws.classList.replace('visible', 'hidden');
    ...
    pickaxeChange(minLvl, name);
}

function step_uws() {
    const curr = document.getElementById('uws');
    curr.addEventListener('change', function () {
        switch (curr.value) {
            case '1': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: железную руду';
                }
                break;
            }
            case '2': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: медную руду';
                }
                break;
            }
        }
...
function step_uwg() {
    const curr = document.getElementById('uwg');
    curr.addEventListener('change', function () {
        switch (curr.value) {
            case '1': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: золотую руду';
                }
                break;
            }
            case '2': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: изумруды';
                }
                break;
            }
        }
...
function step_uw() {
    const curr = document.getElementById('uw');
    curr.addEventListener('change', function () {
        switch (curr.value) {
            case '1': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: уголь';
                }
                break;
            }
            case '2': {
                ...
                uw.classList.replace('visible', 'hidden');
                dw.classList.replace('visible', 'hidden');
                uws.classList.replace('hidden', 'visible');
                uwg.classList.replace('visible', 'hidden');
                p.classList.replace('visible', 'hidden');
            ...
            case '3': {
                ...
                dw.classList.replace('visible', 'hidden');
                uws.classList.replace('visible', 'hidden');
                uwg.classList.replace('hidden', 'visible');
                p.classList.replace('visible', 'hidden');
            ...
            case '4': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: алмазы';
                }
                break;
            }
        }
...
function step_dw() {
    const curr = document.getElementById('dw');
    curr.addEventListener('change', function () {
        switch (curr.value) {
            case '1': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: кварцевую руду';
                }
                break;
            }
            case '2': {
                if (type.value === '2') {
                    ...
                    disableAll();
                    resultLab1.innerText = 'Я получу: золотую руду нижнего мира';
                }
                break;
            }
            case '3': {
                if (type.value === '2') {
                    pickaxe(4, 'древние обломки');
                } else {
                    disableAll();
                    resultLab1.innerText = 'Я получу: древние обломки';
                }
                break;
            }
        }
...
function step_w() {
    const curr = document.getElementById('w');
    curr.addEventListener('change', function () {
        switch (curr.value) {
            case '1': {
                w.classList.replace('visible', 'hidden');
                uw.classList.replace('hidden', 'visible');
                dw.classList.replace('visible', 'hidden');
                uws.classList.replace('visible', 'hidden');
                uwg.classList.replace('visible', 'hidden');
                p.classList.replace('visible', 'hidden');
            ...
            case '2': {
                w.classList.replace('visible', 'hidden');
                uw.classList.replace('visible', 'hidden');
                dw.classList.replace('hidden', 'visible');
                uws.classList.replace('visible', 'hidden');
                uwg.classList.replace('visible', 'hidden');
                p.classList.replace('visible', 'hidden');
...
function restart() {
    ...
    uwg.classList.replace('visible', 'hidden');
    p.classList.replace('visible', 'hidden');
    resultLab1.classList.replace('visible', 'hidden');

    step_w();
}

for (const select of lab1.getElementsByTagName('select')) {
